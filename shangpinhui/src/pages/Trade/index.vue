  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="userAddress in addressInfo"
        :key="userAddress.id"
      >
        <span
          class="username"
        ...
        >
        <p @click="changeDefault(userAddress, addressInfo)">
...
export default {
  ...
  created() {
    ...
    // this.addressInfo = this.$store.state.trade.userAddress
    // this.orderInfo = this.$store.state.trade.orderInfo
    this.getUserAddress();
    this.getOrderInfo();
  },
  computed: {
  ...
  methods: {
    //修改默认地址
    changeDefault(userAddress, addressInfo) {
      //全部的isDefault为零
