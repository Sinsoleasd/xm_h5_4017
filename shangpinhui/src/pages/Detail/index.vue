            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="changeActive(spuSaleAttrValue,spuSaleAttrValue.isChecked)"
                >
...
export default {
  ...
  methods:{
   ...
   async addShopcar(){
      ...
      //当前这里是派发一个action，也想服务器发请求，判断加入购物车是成功还是失败了
      //this.$store.dispatch("addOrUpdateShopCart"),生面这行代码说白了：调用仓库中的addOrUpdateShopCart
